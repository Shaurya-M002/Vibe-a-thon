# Fixtures — backend `llamacpp`, model `slm-clean`

Exact match **30/30**. Median latency **129 ms**, slowest 504 ms.
...
| fx06 | run git checkout dash b vibe slash slm | run git checkout -b vibe/slm | run git checkout -b vibe/slm | yes |
...
| fx11 | send the deck to ananya at skan dot ai before the call | Send the deck to ananya@skan.ai before the call. | Send the deck to ananya@skan.ai before the call. | yes |
...
| fx13 | budget is two lakh rupees actually make that three lakh | Budget is ₹3,00,000. | Budget is ₹3,00,000. | yes |
| fx14 | hey vikram just wanted to check if the devnet token moved thanks meera | Hi Vikram,<br><br>Just wanted to check if the devnet token moved.<br><br>Thanks,<br>Meera | Hi Vikram,<br><br>Just wanted to check if the devnet token moved.<br><br>Thanks,<br>Meera | yes |
...
| fx26 | Okay, so there are three things in my plan. First, I need to go to Hyderabad, and then from there, I need to go to Orissa, and then from there, I need to come back to Vijayawada. | **Plan**<br>- I need to go to Hyderabad<br>- Then from there, I need to go to Orissa<br>- Then from there, I need to come back to Vijayawada | **Plan**<br>- I need to go to Hyderabad<br>- Then from there, I need to go to Orissa<br>- Then from there, I need to come back to Vijayawada | yes |
| fx27 | action items from the standup first review the pull request second update the roadmap and third pay the vendor | **Action Items**<br>- Review the pull request<br>- Update the roadmap<br>- Pay the vendor | **Action Items**<br>- Review the pull request<br>- Update the roadmap<br>- Pay the vendor | yes |
